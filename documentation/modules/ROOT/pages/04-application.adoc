...
**Advanced Cluster Management Console > Applications > Create Application > Argo CD ApplicationSet - Pull model**

image::application/application02.png[]

**Advanced Cluster Management Console > Applications > Create Application > Argo CD ApplicationSet - Pull model> General**
...
**Advanced Cluster Management Console > Applications > Create Application > Argo CD ApplicationSet - Pull model > Template**
