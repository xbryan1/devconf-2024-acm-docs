...
----
oc login -u kubeadmin -p <password> --insecure-skip-tls-verify https://<your_cluster>:6443
----
...
This is the hands-on lab `Git` repository, you might fork the project into your `Github` account as follows:
...
You will find the `rhte2023` folder where there are all resources you need for this lab.
