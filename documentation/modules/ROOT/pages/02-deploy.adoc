...
[source,bash, subs="+macros,+attributes"]
----
vi 02_bootstrap/argocd/rhte2023-bootstrap-gitops.yaml
----

and change `server` to your cluster `https://api.<your_cluster>:6443` and `repoURL` to your git repository `https://github.com/<your_github_account>/rhte-2023-acm-apps.git` forked previously:
