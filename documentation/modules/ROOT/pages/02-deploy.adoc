...
[source,bash, subs="+macros,+attributes"]
----
cd rhte-2023-acm-apps/rhte2023/; oc kustomize 02_boostrap/base/acm_operator/base
----
...
[source,bash, subs="+macros,+attributes"]
----
oc replace -k 02_boostrap/base/openshift/base
----
...
[source,bash, subs="+macros,+attributes"]
----
oc apply -k 02_boostrap/base/acm_operator/base
----
...
[source,bash, subs="+macros,+attributes"]
----
oc apply -k 02_boostrap/base/acm_multiclusterhub/base
----
...
[source,bash, subs="+macros,+attributes"]
----
oc apply -k 02_boostrap/base/gitops_operator/base/
----
...
[source,bash, subs="+macros,+attributes"]
----
oc apply -k 02_boostrap/base/gitops_acm/base/
----
