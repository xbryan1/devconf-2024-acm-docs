...
and change `server` to your cluster `https://<your_cluster>:6443` and `repoURL` to your git repository `https://github.com/<your_github_account>/rhte-2023-acm-apps.git` forked:
